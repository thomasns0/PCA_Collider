...
for ( i in 1:50){
  OutputNames<-rbind(OutputNames, paste0(directory, 'ALLoutR2raw',"_", i, '.csv'))
...
#concat all
#*********
system(paste0('cat ',paste0(OutputNames, collapse=" "),' > ',paste0('CombinedOutputALLoutR2raw','.csv')))
...
FailedRuns<-as.numeric(gsub(paste0('ALLoutR2raw', "_"),"",FailedRuns))
