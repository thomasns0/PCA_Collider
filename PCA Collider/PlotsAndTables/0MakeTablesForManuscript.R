...
EDU_PCA_Vars_RETAINED<-read.table("00ResultsForManuscript/ALCprs_EDU_max_PCAvars.csv", sep=",", header=T)
EDU_PCA_MODELVARS_raw<-read.table("00ResultsForManuscript/ALCprs_EDU_max_MODELvars_RAW.csv", sep=",", header=T)
EDU_PCA_MODELVARS_scaled<-read.table("00ResultsForManuscript/ALCprs_EDU_max_MODELvars_SCALED.csv", sep=",", header=T)
...
out_EDU$Variable[ out_EDU$Variable == "EARLIEST_AlcAgeInit"] <- "Age of Alcohol Initiation"
out_EDU$Variable[ out_EDU$Variable == "EARLIEST_AlcAgeIntox"] <- "Age of First Alcohol Intoxication"
out_EDU$Variable[ out_EDU$Variable == "MAX_age"] <- "Maximum Recorded Age"
out_EDU$Variable[ out_EDU$Variable == "EARLIEST_AlcAgeInit_maternal"] <- "Maternal Age of Alcohol Initiation"
out_EDU$Variable[ out_EDU$Variable == "EARLIEST_AlcAgeInit_paternal"] <- "Paternal Age of Alcohol Initiation"
out_EDU$Variable[ out_EDU$Variable == "EARLIEST_AlcAgeIntox_maternal"] <- "Maternal Age of First Alcohol Intoxication"
out_EDU$Variable[ out_EDU$Variable == "EARLIEST_AlcAgeIntox_paternal"] <- "Paternal Age of First Alcohol Intoxication"
...
write.table(out_EDU, "alcEDU_Table_For_Manuscript.csv", sep=",", row.names=FALSE)
...
FTND_PCA_Vars_RETAINED<-read.table("00ResultsForManuscript/ALCprs_MAX_ftnd_sx_PCAvars.csv", sep=",", header=T)
FTND_PCA_MODELVARS_raw<-read.table("00ResultsForManuscript/ALCprs_MAX_ftnd_sx_MODELvars_RAW.csv", sep=",", header=T)
FTND_PCA_MODELVARS_scaled<-read.table("00ResultsForManuscript/ALCprs_MAX_ftnd_sx_MODELvars_SCALED.csv", sep=",", header=T)
...
out_FTND$Variable[ out_FTND$Variable == "EARLIEST_AlcAgeInit"] <- "Age of Alcohol Initiation"
out_FTND$Variable[ out_FTND$Variable == "EARLIEST_AlcAgeIntox"] <- "Age of First Alcohol Intoxication"
out_FTND$Variable[ out_FTND$Variable == "MAX_age"] <- "Maximum Recorded Age"
out_FTND$Variable[ out_FTND$Variable == "EARLIEST_AlcAgeInit_maternal"] <- "Maternal Age of Alcohol Initiation"
out_FTND$Variable[ out_FTND$Variable == "EARLIEST_AlcAgeInit_paternal"] <- "Paternal Age of Alcohol Initiation"
out_FTND$Variable[ out_FTND$Variable == "EARLIEST_AlcAgeIntox_maternal"] <- "Maternal Age of First Alcohol Intoxication"
out_FTND$Variable[ out_FTND$Variable == "EARLIEST_AlcAgeIntox_paternal"] <- "Paternal Age of First Alcohol Intoxication"
...
write.table(out_FTND, "alcFTND_Table_For_Manuscript.csv", sep=",", row.names=FALSE)
...
write.table(MakeResultsTable(FTND_Results, "TOB"), "alcTOB_ResultsTable.csv", sep=",", row.names=FALSE)
write.table(MakeResultsTable(EDU_Results, "EDU"), "alcEDU_ResultsTable.csv", sep=",", row.names=FALSE)
...
load("00ResultsForManuscript/ObjectsOut__ALCprs__EDU_max")
ObjectsOut_EDU <- ObjectsOut
temp<-R2_TABLE(ObjectsOut_EDU, "EDU")
write.table(rbind(temp[[1]], temp[[2]]), "alcR2_Table_EDU.csv", sep=",", row.names=FALSE)



load("00ResultsForManuscript/ObjectsOut__ALCprs__MAX_ftnd_sx")
ObjectsOutFTND <- ObjectsOut
temp<-R2_TABLE(ObjectsOutFTND, "TOB")
write.table(rbind(temp[[1]], temp[[2]]), "alcR2_Table_TOB.csv", sep=",", row.names=FALSE)


#rGE 
load("00ResultsForManuscript/ALCprs_EDU_maxtargetEnv_hetcor")
rGE
load("00ResultsForManuscript/ALCprs_MAX_ftnd_sxtargetEnv_hetcor")
