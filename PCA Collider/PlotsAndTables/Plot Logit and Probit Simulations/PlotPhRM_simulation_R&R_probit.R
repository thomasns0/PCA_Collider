library(ggplot2)
w<-read.table('~/Documents/0 PhenoSimMatrix/000MANUSCRIPT/000Resubmission1BGA/scripts/CombinedOutputProbitALLoutB.csv', sep=",", header=FALSE)
...
####################################################################
####################################################################
png("PLOT1_R&Rprobit.tiff", width = 2250, height = 2550, units = 'px', res = 300)
...
####################################################################
####################################################################
png("PLOT2_R&Rprobit.tiff", width = 2250, height = 2550, units = 'px', res = 300)
...
####################################################################
####################################################################
png("PLOT3_R&Rprobit.tiff", width = 2250, height = 2550, units = 'px', res = 300)
...
####################################################################
####################################################################
png("PLOT4_R&Rprobit.tiff", width = 2250, height = 2550, units = 'px', res = 300)
